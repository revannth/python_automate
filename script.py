...
for el in root.iter('img'):
    el.attrib['src'] = str("ccd_pics/") + str(result[i])
    i+=1
i=0
for el in root.iter('h1'):
	el.text = str("ccd_pics/") + str(result[i])
	i+=1
print(LH.tostring(root, pretty_print=True))
with open(r'/Users/vedalasrinivas/Desktop/sreevani-dhulipala.github.io/index.html',"w") as f:
